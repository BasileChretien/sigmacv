...
- [ ] **DORA — signature NOT confirmed.** Outreach was done and acknowledged: DORA's Program Manager replied on 2026-08-14 thanking us for sharing SigmaCV and saying they will keep it in mind for examples, resources and case studies — but the reply **says nothing about a signature**, and Basile does not recall completing one. Signing is open to anyone at <https://sfdora.org/sign>; verify against the public signers list before claiming it. Until then the public wording stays **"aligned"**, which [`docs/OPEN-SCIENCE.md`](docs/OPEN-SCIENCE.md) already states accurately — do not upgrade it to "signatory". (This item was briefly ticked in #347 on a recollection; #350 reverted it.) CoARA needs no action: the docs claim **alignment**, not membership, and that claim is substantiated by the narrative/contribution-focused CV models (R4RI, Royal Society, SNSF, NWO, Wellcome).

...
- [x] **DORA signed** (<https://sfdora.org/>, confirmed 2026-08-20). The stance was already stated in [`docs/OPEN-SCIENCE.md`](docs/OPEN-SCIENCE.md); the project is now an actual signatory, not merely aligned. Still open from this item: **record CoARA alignment**, and decide whether to state signatory status publicly (README badge / `docs/OPEN-SCIENCE.md`) rather than only here.

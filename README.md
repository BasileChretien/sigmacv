...
<!--
  MAINTAINER: add a screenshot or short GIF of a generated CV here — this is the
  single highest-impact addition for non-technical visitors. Suggested:
  ![Example CV generated by SigmaCV](docs/images/example-cv.png)
  Put the image in docs/images/ and update the path above, then delete this comment
  and the placeholder line below.
-->
<p align="center"><em>Screenshot of an example CV coming soon.</em></p>

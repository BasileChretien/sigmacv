...
- **Homepage: a quiet entry to the lookup.** Under the sign-in card's preview form, one line for the visitor who is not the owner — "Looking for someone else? Find a researcher by name" (ten locales) — linking `/search`. The hero and the sign-in call to action are unchanged.

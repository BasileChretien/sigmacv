    ...
    <fieldset className={`display-controls${grouped ? " display-controls--grouped" : ""}`}>
      ...
      <StyleGroup grouped={grouped} title={eu.grpDisplay} defaultOpen={false}>
        ...
        <label className="field-inline">
          <input
            type="checkbox"
            checked={cv.display.showOutputLedger}
            onChange={(e) => onChange(updateDisplay(cv, { showOutputLedger: e.target.checked }))}
          />
        ...
        <label className="field-inline">
          <input
            type="checkbox"
            checked={cv.display.holdNewForReview}
            onChange={(e) => onChange(updateDisplay(cv, { holdNewForReview: e.target.checked }))}
          />
          <span>{u.holdNewForReview}</span>
        </label>
        ...
        <label className="field-inline">
          <input
            type="checkbox"
            checked={cv.display.showVerifiedBadges}
            onChange={(e) => onChange(updateDisplay(cv, { showVerifiedBadges: e.target.checked }))}
          />
          <span>{u.showVerifiedBadges}</span>
        </label>
        ...
        <label className="field-inline">
          <input
            type="checkbox"
            checked={cv.display.showDataLinks}
            onChange={(e) => onChange(updateDisplay(cv, { showDataLinks: e.target.checked }))}
          />
          <span>{u.showDataLinks}</span>
        </label>

        <label className="field-inline">
          <input
            type="checkbox"
            checked={cv.display.showReplications}
            onChange={(e) => onChange(updateDisplay(cv, { showReplications: e.target.checked }))}
          />
          <span>{u.showReplications}</span>
        </label>

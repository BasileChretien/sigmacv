 ...
 *  - knowledge   → the scholarly outputs (publications, preprints, conference, datasets, software);
...
const EVIDENCE_SECTIONS: Partial<Record<CvSectionType, CvSectionType[]>> = {
  "narrative-knowledge": ["publications", "preprints", "conference", "datasets", "software"],

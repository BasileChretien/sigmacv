...
const UI_I18N: Record<Locale, UiStrings> = {
  "en-US": {
    ...
    exportDocx: "Word .docx (plain)",
    exportLatexModern: "LaTeX — Modern (.tex)",
    exportLatexClassic: "LaTeX — Classic (.tex)",
    exportMarkdown: "Markdown .md (plain)",
  ...
  "zh-CN": {
    ...
    exportDocx: "Word .docx（朴素版）",
    exportLatexModern: "LaTeX — 现代版（.tex）",
    exportLatexClassic: "LaTeX — 经典版（.tex）",
    exportMarkdown: "Markdown .md（朴素版）",
  ...
  "es-ES": {
    ...
    exportDocx: "Word .docx (sencillo)",
    exportLatexModern: "LaTeX — Moderna (.tex)",
    exportLatexClassic: "LaTeX — Clásica (.tex)",
    exportMarkdown: "Markdown .md (sencillo)",
  ...
  "fr-FR": {
    ...
    exportDocx: "Word .docx (simple)",
    exportLatexModern: "LaTeX — Moderne (.tex)",
    exportLatexClassic: "LaTeX — Classique (.tex)",
    exportMarkdown: "Markdown .md (simple)",
  ...
  "de-DE": {
    ...
    exportDocx: "Word .docx (schlicht)",
    exportLatexModern: "LaTeX — Modern (.tex)",
    exportLatexClassic: "LaTeX — Klassisch (.tex)",
    exportMarkdown: "Markdown .md (schlicht)",
  ...
  "ja-JP": {
    ...
    exportDocx: "Word .docx（プレーン）",
    exportLatexModern: "LaTeX — モダン（.tex）",
    exportLatexClassic: "LaTeX — クラシック（.tex）",
    exportMarkdown: "Markdown .md（プレーン）",
  ...
  "pt-BR": {
    ...
    exportDocx: "Word .docx (simples)",
    exportLatexModern: "LaTeX — Moderno (.tex)",
    exportLatexClassic: "LaTeX — Clássico (.tex)",
    exportMarkdown: "Markdown .md (simples)",
  ...
  "it-IT": {
    ...
    exportDocx: "Word .docx (semplice)",
    exportLatexModern: "LaTeX — Moderno (.tex)",
    exportLatexClassic: "LaTeX — Classico (.tex)",
    exportMarkdown: "Markdown .md (semplice)",
  ...
  "ko-KR": {
    ...
    exportDocx: "Word .docx (단순)",
    exportLatexModern: "LaTeX — Modern (.tex)",
    exportLatexClassic: "LaTeX — Classic (.tex)",
    exportMarkdown: "Markdown .md (단순)",
  ...
  "ru-RU": {
    ...
    exportDocx: "Word .docx (простой)",
    exportLatexModern: "LaTeX — Современный (.tex)",
    exportLatexClassic: "LaTeX — Классический (.tex)",
    exportMarkdown: "Markdown .md (простой)",

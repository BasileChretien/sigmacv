...
export type AnyLandingPageId = LandingPageId | PersonaPageId | TopicPageId;

/** Every landing-page id (original SEO pages + persona pages + topic pages). */
...
/** Thin localized copy for any landing/persona/topic page. */
...
/** Deep localized content for any landing/persona/topic page. */
...
/** Related-page ids (hub-and-spoke) for any landing/persona/topic page. */

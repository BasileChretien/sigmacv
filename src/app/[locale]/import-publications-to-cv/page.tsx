...
/** Localized "Import publications to CV" topic page (/fr/import-publications-to-cv, …). */
...
export default async function LocaleImportPublicationsToCvPage({ params }: Params) {
  const { locale: slug } = await params;
  const loc = localeForSlug(slug);

...
const PAGE = "grad-school-cv" as const;

/** Localized "Grad-school CV" persona page (/fr/grad-school-cv, …). */
...
export default async function LocaleGradSchoolCvPage({ params }: Params) {
  const { locale: slug } = await params;
  const loc = localeForSlug(slug);

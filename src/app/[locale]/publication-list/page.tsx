...
const PAGE = "publication-list" as const;

/** Localized "Publication list" landing page — a crawlable URL per language with
...
export default async function LocalePublicationListPage({ params }: Params) {
  const { locale: slug } = await params;
  const loc = localeForSlug(slug);

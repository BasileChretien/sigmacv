...
- **Funder-ready in one click.** A 61-model CV-model catalog reconfigures the CV
...
| CV models    | 61 one-click, reversible layouts: grant funders · public-institution/job CVs · industry/clinical CVs                            |

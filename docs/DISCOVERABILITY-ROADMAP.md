...
| C6  | **Glossary / concept pages** — ORCID, OpenAlex, FWCI, h-index, CSL, Sigma-Score, biosketch, Europass… Entity coverage that LLMs cite and that wins "what is X" queries; internally links to the tool.                                                                                                                                                                                                                                                                    | 🧑‍💻                    | M      | ⬜     |
